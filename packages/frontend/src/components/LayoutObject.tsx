import { Box, TextField, Checkbox, FormGroup, FormControlLabel, Divider, IconButton, Tooltip } from '@mui/material';
...
export const LayoutComponent: FC<LayoutComponentProps> = (props) => {
  ...
  const handleTextChange = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, _min: number, _max: number) => {
    if (event.target) {
            ...
            <Box key={index} display={'flex'} flexDirection={'column'}>
              ...
              {selectedOption === option && (
                <TextField
                  ...
                  value={mediaVol}
                  onChange={(e) => handleTextChange(e, option.min, option.max)}
